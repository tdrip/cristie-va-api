...
type Event struct {
	...
	BlockId           int       `json:"blockId,omitempty"`           // 0
	...
	Error             int       `json:"error,omitempty"`             // 0
	Failed            int       `json:"failed,omitempty"`            // 0
	...
	Id                int       `json:"id,omitempty"`                // ID of the event - 323
	...
	Percent           int       `json:"percent,omitempty"`           // 0
